...
export class NewGameComponent {
  ...
  constructor(){
    this.formulario = new FormGroup({
      ...
      detailed_description: new FormControl(null, [
        Validators.required
      ]),
      about_the_game: new FormControl(null, [
        Validators.required
      ]),
      ...
      capsule_image: new FormControl(null, [
        Validators.required
      ]),
      capsule_imagev5: new FormControl(null, [
        Validators.required
      ]),
      ...
      developers: new FormControl(null, [
        Validators.required
      ]),
